...
struct SheetAtrevido: View {
    ...
    var body: some View {
        ZStack {
            LinearGradient(gradient: Gradient(colors: [Color("ColorExtremoLight"), Color("ColorExtremoDark")]), startPoint: .top, endPoint: .bottom)
            ...
            VStack(spacing: 0) {
                ...
                HStack{
                    Button(action: {
                        verdadReto = (verdadRetoData.verdadAtrevido.randomElement()!)
                        if sonidoToggle {
                    ...
                    Button(action: {
                        verdadReto = (verdadRetoData.retoAtrevido.randomElement()!)
                        if sonidoToggle {
                            playSound(sound: "sound-tap", type: "mp3")
                        }
                    }, label: {
...
struct SheetAtrevido_Previews: PreviewProvider {
