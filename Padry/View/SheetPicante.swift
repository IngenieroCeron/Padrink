...
struct SheetPicante: View {
    ...
    var body: some View {
        ZStack {
            LinearGradient(gradient: Gradient(colors: [Color("ColorPicanteLight"), Color("ColorPicanteDark")]), startPoint: .top, endPoint: .bottom)
            ...
            VStack(spacing: 0) {
                ...
                HStack{
                    Button(action: {
                        verdadReto = (verdadRetoData.verdadPicante.randomElement()!)
                        if sonidoToggle {
                    ...
                    Button(action: {
                        verdadReto = (verdadRetoData.retoPicante.randomElement()!)
                        if sonidoToggle {
                            playSound(sound: "sound-tap", type: "mp3")
                        }
                    }, label: {
...
struct SheetPicante_Previews: PreviewProvider {
